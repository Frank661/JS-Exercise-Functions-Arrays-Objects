...
function getCarInfoByIndex(inventory, index) {
    ...
    let car_make1 = inventory[index].car_make;
    let car_model1 = inventory[index].car_model;
...
console.log('task 9 ')
 ...
 var exports = [
  ...
  function getLastCarInfo(index) {
    let car_make1 = exports[index].car_make;
    let car_model1 = exports[index].car_model;
    return `This is a ${car_make1}  ${car_model1}.`;

  }
 console.log(getLastCarInfo(49));
...
function getModelYears() {
  ...
  console.log(exports[i].car_year)
}
getModelYears();
